<?php
	...
	if($usuarioId>0)
	{
		$usuarios->getUsuarios($usuarioId);
	}
?>
<!doctype html>
 ...
 <div class="container">
  ...
  <form>
    <div class="clearfix">
      ...
      <div class="input">
      	<input name="nombre" type="text" id="nombre" value="<?php echo $usuarios->dataQuery[0]->nombre;?>"/>
        <input type="hidden" name="userId" id="userId" value="<?php print $usuarioId; ?>">
      </div>
    </div>
    <div class="clearfix">
    ...
    <div class="clearfix">
      ...
      <div class="input">
      	<input name="email" type="text" id="email"  value="<?php echo $usuarios->dataQuery[0]->email;?>"/>
      </div>
    </div>
    
  <div class="clearfix">
    <div class="input">
      <input name="Botón" type="button" class="btn btn-primary" onClick="updateValidateGeneral();" value="Aceptar" />
